...
- `.claude/docs/knowledge-graph.md` — schema spec güncellenecek (open questions section eklenecek)
- `.claude/docs/database-schema.md` — KuzuDB tablo tanımları detaylanacak (V1 final schema)
- `.claude/decisions/adr-005-knowledge-graph.md` — bu ADR onun extension'ı; ADR-005 indexing strategy'sini, ADR-010 schema attribute'larını fix eder
