...
flowchart TB
  ...
  %% Şu an
  M25 ==> NOW(["ŞİMDİ BURADA<br/>━━━━━━━━━━━━━━━<br/>68 commit · 170 MCP tool · index_slot 30s→4s (7.5x)<br/>Phase 1+2+3+4.0/4.1/4.2(r1+r2)/4.3/4.4/4.5-r1+r2-b1/4.6(r1+r2+r3-b1..b5)/4.7 CANLI<br/>SageTest UE 5.7 — 8K asset · 16K dep · 8337 class · 8336 inherit · 492 engine module<br/>Phase 4.5-r2-b1: asset.list (761) + search · read_properties<br/>UE-MCP 448 action audit → Phase 4 yol haritası %73 done"]):::now
  ...
  subgraph P4["Phase 4 — Full UE-MCP capability parity"]
    ...
    P45["4.5 Asset advanced r1+r2-b1 ✓ (10 tool)<br/>r1: mesh_bounds · mesh_collision · diagnose_registry<br/>list_redirectors · bulk_rename · move_folder · fixup_redirectors<br/>r2-b1: list · search · read_properties (asset query)<br/><i>r2-b2+: import_fbx/texture · datatable · FTS · sockets</i>"]:::done
