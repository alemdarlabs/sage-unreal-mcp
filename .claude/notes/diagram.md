...
flowchart TB
  ...
  subgraph P4["Phase 4 — Full UE-MCP capability parity"]
    ...
    P46["4.6 Editor automation r1..r3/b6 ✓ (30 tool)<br/>r1: console · screenshot · engine/project · log<br/>r2 (dialog): policy CRUD · list/respond_dialogs<br/>r3-b1: undo · redo · focus_on_actor · set_viewport<br/>r3-b2: set_property · set_pie_time_scale<br/>r3-b3: search_log · list/check_crashes · get_crash_info<br/>r3-b4: build_all/geometry/lighting/hlod · get_build_status<br/>r3-b5: run_python (IPythonScriptPlugin)<br/>r3-b6: seq.create + list_tracks + add_track (sequencer minimal)<br/><i>r3 remaining: seq.add_keyframe · seq.add_possessable · spawnable</i>"]:::done
