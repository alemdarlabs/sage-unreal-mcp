...
flowchart TB
  ...
  %% Şu an
  M25 ==> NOW(["ŞİMDİ BURADA<br/>━━━━━━━━━━━━━━━<br/>47 commit · 112 MCP tool<br/>Phase 1 + 2 + 3 + 4.0/4.1/4.2-r1+r2a/4.3/4.5-r1/4.6-r1+r2 CANLI<br/>SageTest UE 5.7 — 8K asset · 16K dep · 8337 class · 8336 inherit<br/>BP authoring + graph node CRUD · Material · Asset · Editor · Dialog<br/>UE-MCP 448 action audit → Phase 4 yol haritası %53 done"]):::now
  ...
  subgraph P4["Phase 4 — Full UE-MCP capability parity"]
    ...
    P42["4.2 Blueprint authoring (round 1+2a) ✓ (21 tool)<br/>r1: read/list_vars/fns/function graph/components/search<br/>add/delete var·fn · delete_node · connect_pins<br/>set_cdo_property · reparent · compile<br/>r2a: add_node · set/read_node_property · list_node_types<br/><i>round 2b/c: ~21 tool kaldı (T3D, rename, fn I/O, interface, ...)</i>"]:::done
