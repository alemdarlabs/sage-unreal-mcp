...
flowchart TB
  ...
  %% Şu an
  M25 ==> NOW(["ŞİMDİ BURADA<br/>━━━━━━━━━━━━━━━<br/>61 commit · 149 MCP tool · index_slot 30s→4s (7.5x)<br/>Phase 1+2+3+4.0/4.1/4.2(r1+r2)/4.3/4.4/4.5-r1/4.6-r1+r2/4.7-p1+p2+p3 CANLI<br/>SageTest UE 5.7 — 8K asset · 16K dep · 8337 class · 8336 inherit · 492 engine module<br/>Phase 4.7 project introspection: 11 tool (project + engine + INI tree)<br/>UE-MCP 448 action audit → Phase 4 yol haritası %66 done"]):::now
  ...
  subgraph P4["Phase 4 — Full UE-MCP capability parity"]
    ...
    P47["4.7 Project introspection (round 1+2+3) ✓ (11 tool)<br/>p1: get_info · list_modules · read_cpp_header · read_cpp_source<br/>p2: search_cpp · list_engine_modules · read_engine_header · find_engine_symbol<br/>p3: read_config · search_config · list_config_tags<br/><i>round 4: set_config (W) + plugin enable/disable + project.build</i>"]:::done
