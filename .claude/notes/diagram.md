...
flowchart TB
  ...
  %% Şu an
  M25 ==> NOW(["ŞİMDİ BURADA<br/>━━━━━━━━━━━━━━━<br/>67 commit · 167 MCP tool · index_slot 30s→4s (7.5x)<br/>Phase 1+2+3+4.0/4.1/4.2(r1+r2)/4.3/4.4/4.5-r1/4.6(r1+r2+r3-b1..b5)/4.7 CANLI<br/>SageTest UE 5.7 — 8K asset · 16K dep · 8337 class · 8336 inherit · 492 engine module<br/>Phase 4.6-r3-b5: editor.run_python — IPythonScriptPlugin + unreal module<br/>UE-MCP 448 action audit → Phase 4 yol haritası %72 done"]):::now
