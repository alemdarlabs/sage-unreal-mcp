...
flowchart TB
  ...
  %% Şu an
  M25 ==> NOW(["ŞİMDİ BURADA<br/>━━━━━━━━━━━━━━━<br/>51 commit · 123 MCP tool<br/>Phase 1 + 2 + 3 + 4.0/4.1/4.2-r1+r2a..r2e/4.3/4.5-r1/4.6-r1+r2 CANLI<br/>SageTest UE 5.7 — 8K asset · 16K dep · 8337 class · 8336 inherit<br/>BP authoring + node + locals + interfaces + graphs + fn I/O · Material · Asset · Editor · Dialog<br/>UE-MCP 448 action audit → Phase 4 yol haritası %57 done"]):::now
