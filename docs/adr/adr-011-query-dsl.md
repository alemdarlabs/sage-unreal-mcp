...
## Etkilenen Belgeler
- `docs/engineering/api-spec.md` — `query()` tool sözleşmesi detaylanacak
- `docs/archive/legacy-graph/knowledge-graph.md` — query examples eklenecek (V1 implementation sırasında)
