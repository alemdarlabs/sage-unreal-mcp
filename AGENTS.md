...
**Status (2026-04-30): production code aktif** — Phase 1+2+3+4 + Milestone 1.5b tamamlandı, ilk gerçek dogfooding turu (11 gap fix tek oturumda) bitti, Mac→Windows production transition başlıyor. Mimari kararlar [`.Codex/decisions/`](.Codex/decisions/) (17 ADR), sistem dokümantasyonu [`.Codex/docs/`](.Codex/docs/), kabul edilen davranış kuralları [`.Codex/notes/lessons.md`](.Codex/notes/lessons.md).
...
- **Dokümantasyon**:
  - [`.Codex/notes/diagram.md`](.Codex/notes/diagram.md) — milestone akışı + tool dağılımı + knowledge graph şeması
  ...
  - [`.Codex/decisions/`](.Codex/decisions/) — 17 ADR (son: ADR-017 multi-editor-routing-impl, ADR-016 distribution-channel-npm)
...
- [Database Schema](.Codex/docs/database-schema.md) — KuzuDB graph schema + SQLite tables
- [Project Structure](.Codex/docs/project-structure.md) — Klasör yapısı ve konvansiyonlar
- [Knowledge Graph](.Codex/docs/knowledge-graph.md) — 3-tier indexing detayı + schema
...
- [Decisions (ADR)](.Codex/decisions/) — Architectural Decision Records (17 ADRs · son: ADR-017 multi-editor-routing-impl)
